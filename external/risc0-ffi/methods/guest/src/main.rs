...
// // commitment = sha512Half( 0x01 || value(8) || rho(32) || r(32) || a_pk(32) )
...
//     match mode {
//         MODE_DEPOSIT => {
//             // mode(1) || value(8) || rho(32) || r(32) || a_pk(32)
...
//         MODE_SPEND => {
//             // mode(1) || value(8) || rho(32) || r(32) || a_pk(32) || a_sk(32)
...
// commitment = sha256( 0x01 || value(8) || rho(32) || r(32) || a_pk(32) )
fn compute_commitment(
    value_be: &[u8; 8],
    rho: &[u8; 32],
    r: &[u8; 32],
